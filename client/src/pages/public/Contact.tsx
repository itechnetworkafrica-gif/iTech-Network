...
export default function Contact() {
  return (
    <div className="min-h-screen flex flex-col font-sans bg-gray-950 text-white">
      ...
      <section className="pt-40 pb-32 md:pt-48 md:pb-40 text-center relative overflow-hidden bg-gray-950">
      ...
      <section className="py-24 bg-gray-900 border-t border-white/10 rounded-t-[3rem] -mt-10 relative z-20">
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-6">
                <div className="bg-gray-950 p-8 rounded-[2rem] border border-white/5 flex items-start gap-5 group hover:border-brand-green/30 hover:shadow-xl transition-all">
                  <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-brand-green transition-colors shadow-sm">
                    <Building2 className="w-6 h-6 text-white group-hover:text-white transition-colors" />
                  </div>
                  <div>
                    <p className="font-black text-xl mb-1 uppercase tracking-tight">Corporate HQ</p>
                    <p className="text-gray-400 leading-relaxed font-medium">Monrovia, Liberia<br />Global Technology Center</p>
                  </div>
                </div>
            ...
            {/* Form Card */}
            <div className="lg:col-span-3 bg-gray-900 rounded-[3rem] p-10 md:p-14 shadow-2xl relative overflow-hidden border border-white/10 text-white">
               <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-10 mix-blend-overlay"></div>
               ...
               <div className="relative z-10">
                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Corporate Email</label>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="phone" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Phone Number</label>
                    ...
                    <div className="space-y-2">
                      <label htmlFor="company" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Company / Org</label>
                      <Input id="company" placeholder="Acme Corp" className="bg-white/5 border-white/10 focus:border-brand-green focus:bg-white/10 text-white h-14 rounded-xl px-5 transition-all placeholder:text-gray-600" />
                    </div>
                  </div>
                  
                  <div className="space-y-2">
                    <label htmlFor="subject" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Primary Interest</label>
                    <select id="subject" className="w-full bg-white/5 border border-white/10 focus:border-brand-green focus:bg-white/10 text-white h-14 rounded-xl px-5 transition-all outline-none appearance-none cursor-pointer">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Project Details</label>
                    <Textarea 
                      id="message" 
                      placeholder="Describe your architectural requirements, challenges, and timeline..." 
                      className="min-h-[160px] bg-white/5 border-white/10 focus:border-brand-green focus:bg-white/10 text-white rounded-xl p-5 resize-none transition-all placeholder:text-gray-600"
                    />
                  </div>
                  
                  <div className="pt-4 border-t border-white/10">
                    <Button className="w-full bg-brand-green hover:bg-green-600 text-white h-16 text-sm font-black uppercase tracking-widest rounded-xl shadow-[0_0_30px_rgba(55,182,38,0.2)] transition-all hover:-translate-y-1 group cursor-pointer">
                      Transmit Inquiry <Send className="w-5 h-5 ml-3 group-hover:translate-x-1 transition-transform" />
                    </Button>
                    <p className="text-xs text-gray-500 font-medium mt-4 text-center">
                      By submitting this form, you acknowledge our <a href="/privacy-policy" className="text-brand-green hover:underline">Privacy Policy</a> and consent to zero-trust data protocols.
                    </p>
                  </div>
                </form>
               </div>
      ...
      <section className="py-32 bg-gray-950 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">Worldwide Infrastructure</h2>
            <p className="text-gray-400 text-lg">Operating across multiple time zones to provide uninterrupted engineering support and server reliability.</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gray-900 rounded-[2.5rem] p-10 border border-white/10 text-center hover:border-brand-green/50 hover:shadow-[0_0_40px_rgba(55,182,38,0.1)] transition-all group">
              <div className="w-20 h-20 bg-gray-950 border border-white/5 rounded-2xl mx-auto flex items-center justify-center mb-6 group-hover:bg-brand-green transition-colors">
                <Globe2 className="w-10 h-10 text-white group-hover:text-white transition-colors" />
              </div>
              <h3 className="text-2xl font-black text-white mb-2 uppercase">West Africa</h3>
              <p className="text-gray-400 font-medium">Monrovia, Liberia<br />Global Technology Center</p>
            </div>
            ...
            <div className="bg-gray-900 rounded-[2.5rem] p-10 border border-white/10 text-center hover:border-brand-green/50 hover:shadow-[0_0_40px_rgba(55,182,38,0.1)] transition-all group">
              ...
              <h3 className="text-2xl font-black text-white mb-2 uppercase">East Africa</h3>
              <p className="text-gray-400 font-medium">Nairobi, Kenya<br />Development Hub</p>
            </div>
            ...
            <div className="bg-gray-900 rounded-[2.5rem] p-10 border border-white/10 text-center hover:border-brand-green/50 hover:shadow-[0_0_40px_rgba(55,182,38,0.1)] transition-all group">
              ...
              <h3 className="text-2xl font-black text-white mb-2 uppercase">North America</h3>
              <p className="text-gray-400 font-medium">Delaware, USA<br />Partner Operations</p>
            </div>
          </div>
        </div>
      </section>
