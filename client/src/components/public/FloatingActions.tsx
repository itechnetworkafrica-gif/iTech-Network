  ...
  return (
    <div className="fixed bottom-8 left-8 z-50 flex flex-col gap-4 font-sans">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="flex items-center justify-center w-12 h-12 bg-brand-green text-white rounded-full shadow-xl hover:bg-brand-green transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 ml-2"
